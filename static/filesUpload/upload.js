(function( $ ){
    ...
    $(function() {
        ...
        function getDialogData(){
            ...
            //alert(dialogData.id + "+" + dialogData.pid);
            treeid = dialogData.id;
            treepid = dialogData.pid
            };
        getDialogData();
        var $wrap = $('#uploader'),
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '../static/filesUpload/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: 'uploadFiles',
            // runtimeOrder: 'flash',
        ...
        function addFile( file ) {
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if ( error ) {
                        //$wrap.text( '不能预览...' );
                        $wrap.empty().append($('<img src="../static/filesUpload/cloud-upload-on.png">'));
                        return;
                    }
